namespace crossql.sqlite
{
    public class SqliteDialect : IDialect
    {
        ...
        public string Byte => "integer";

        public string ByteArray => "blob";

        public string DateTime => "text";

        public string DateTimeOffset => "text";

        public string Decimal => "text";

        public string Double => "real";

        public string Guid => "blob";

        public string Integer => "integer";

        public string Int64 => "integer";

        public string Int16 => "integer";

        public string LimitedString => "text";

        public string MaxString => "text";

        public string Single => "real";

        public string TimeSpan => "text";
